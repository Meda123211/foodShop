...
const Cards=({name,image,text , handleCarts={handleCarts}})=>{

// const styleCardDiv=["card-body title-text-active ",'card-body title-text']
...
<img src={image}className="img-hover card-img-top img-fluid" alt="..."/>
  ...
  <div className='card-body title-text-active'>
